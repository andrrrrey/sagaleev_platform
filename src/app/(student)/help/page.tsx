    ...
    <div className="px-6 py-8 md:px-10 md:py-12">
      ...
      <div className="flex flex-col gap-6">
        ...
        <Panel title="Агент-куратор // Ваш ИИ-наставник">
          <div className="flex flex-col gap-2 p-6 text-sm font-light leading-relaxed text-t700">
            <p>
              В единую подписку входит ИИ-куратор: раз в неделю он смотрит, что вы внедрили, и присылает
        ...
        <Panel title="Если застряли // Помощь">
          <div className="flex flex-col gap-3 p-6 text-sm font-light leading-relaxed text-t700">
            <p>
              Скопируйте в ChatGPT/Codex название шага и безопасный текст ошибки. Напишите:
              «Объясни одно следующее действие и назови точное окно, куда это вводить».
            </p>
            <p>
              Не отправляйте в чат пароль, Telegram-токен, API-ключ, IP сервера или данные клиентов.
              На скриншоте закройте эти данные до отправки.
            </p>
            <p>
              Если помощник не решил проблему, напишите в канал поддержки, который вы получили при
              покупке доступа. Укажите день, номер шага, что нажали и безопасный текст ошибки — без
              секретов. На тарифах сопровождения можно также обратиться к своему куратору.
            </p>
            <Link
              href="/profile?tab=codex"
              className="inline-flex items-center gap-2 font-mono text-[11px] text-accent hover:underline"
            >
              Подключить Codex к маршруту через MCP <Icon name="arrow-right-linear" />
            </Link>
          </div>
        </Panel>
      </div>
